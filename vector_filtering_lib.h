...
#ifdef BUILDING_DLL
#define DELLEXPORT __attribute__((visibility("default")))  // Export symbols when building the shared library
#else
#define DELLEXPORT  // No need for special import declaration on Linux
#endif
#else
